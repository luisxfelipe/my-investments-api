...
export class TransactionResponseDto {
    ...
    @ApiProperty({ description: 'Transaction Type', type: TransactionTypeResponseDto })
    ...
    constructor(transaction: Transaction) {
        ...
        if (transaction.transactionType) {
            this.transactionType = new TransactionTypeResponseDto(transaction.transactionType);
        }
    }
}